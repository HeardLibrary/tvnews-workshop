$(function() {
    ...
    $("#contactForm input,#contactForm textarea").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            $.ajax({
                url: "http://www.library.vanderbilt.edu/webimages/semanticweb/contact_me.php",
                type: "POST",
                data: {
                    name: name,
                    phone: phone,
                ...
                error: function() {
                    ...
                    $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .alert-danger').append("<strong>Sorry " + firstName + ", something went wrong on our end. Please try again later.");
